// Official contract for stable xrc token by mohzcrea8me
//A $DAI like token that follows XRC20 token standards as stated on xdc docs:
//visit https://docs.xdc.community/get-details/smart-contract-details/xrc-standards/xrc20 and more
