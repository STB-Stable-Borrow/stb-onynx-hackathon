...
function MobileAllTokenization({ data }) {
    ...
    <div className="flex w-full items-center flex-col gap-4 text-[#B0B0B0] font-semibold text-xs bg-[#292C31] rounded-[0.625rem] py-[1.11vh]  px-[3.38vw]">
      <div className="flex items-center justify-between w-full">
        <div className="flex items-center gap-4">
          <p>#{data.id}</p>
          <div className="flex items-center gap-1 w-[22.46vw]   ">
            <img
              src={stc}
              alt=""
        ...
        <div className="flex items-center gap-4 w-[38.46vw]  ">
      ...
      {expanded && (
        <div className="flex items-center justify-between w-full">
          <h2 className="w-[22.46vw] ">Profit: ${data.profit}</h2>
          <h2 className=" w-[38.46vw] ">Profit Amount: ${data.profitAmount}</h2>
        </div>
      )}
    </div>
  );
...
export default MobileAllTokenization;
